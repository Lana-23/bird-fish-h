#!/usr/bin/env python3
"""
Download images for saltwater tropical fish species.
Uses Wikimedia Commons API with thumbnail URLs.

Usage:
    python3 download-fish-tropical.py              # Download all species
    python3 download-fish-tropical.py --start 50   # Start from item 50
"""
